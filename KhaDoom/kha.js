...
Main.main = function() {
	kha_System.start(new kha_SystemOptions("KhaDoom",320,200,null,null),function(_) {
...
$hxClasses["geom.Point"] = geom_Point;
geom_Point.__name__ = true;
geom_Point.prototype = {
	x: null
	,y: null
	,__class__: geom_Point
};
...
var kha__$Assets_BlobList = function() {
	this.names = ["DOOM1_WAD"];
	this.DOOM1_WADDescription = { name : "DOOM1_WAD", files : ["DOOM1.WAD"], type : "blob"};
	this.DOOM1_WADName = "DOOM1_WAD";
	this.DOOM1_WAD = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,DOOM1_WAD: null
	,DOOM1_WADName: null
	,DOOM1_WADDescription: null
	,DOOM1_WADLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 138, className : "kha._Assets.BlobList", methodName : "DOOM1_WADLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadBlob("DOOM1_WAD",function(blob) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 138, className : "kha._Assets.BlobList", methodName : "DOOM1_WADLoad"});
	}
	,DOOM1_WADUnload: function() {
		this.DOOM1_WAD.unload();
		this.DOOM1_WAD = null;
	}
	,names: null
...
var waddata_WadDataGlobal = function() { };
$hxClasses["waddata.WadDataGlobal"] = waddata_WadDataGlobal;
waddata_WadDataGlobal.__name__ = true;
waddata_WadDataGlobal.addBspMap = function(_map) {
	waddata_WadDataGlobal.iwad_keys.push(_map.name);
	var this1 = waddata_WadDataGlobal.maps;
	var k = _map.name;
	var v = new waddata_packages_processed_PMap(_map);
	var _this = this1;
...
var waddata_packages_WadReader = function(_data,_name,_iwad) {
	if(_iwad == null) {
		_iwad = false;
	}
	...
	var this1 = waddata_WadDataGlobal.iwad_data;
	var v = this.b_dataArray.slice();
	var _this = this1;
	...
	waddata_WadDataGlobal.iwad_keys.push(_name);
	this.name = _name;
	this.iwad = _iwad;
};
$hxClasses["waddata.packages.WadReader"] = waddata_packages_WadReader;
waddata_packages_WadReader.__name__ = true;
waddata_packages_WadReader.prototype = {
	deconstructed: null
	,processed: null
	,b_dataArray: null
	,directories: null
	...
	,deconstruct: function() {
		...
		while(_g < _g1) {
			...
			if(this.directories[a].lumpName == "BLOCKMA") {
				var map = { name : this.name + ":" + this.directories[a - 10].lumpName, iwad : this.name, vertexes : this.readVertextData(this.directories[a - 6]), linedefs : this.readLineDefData(this.directories[a - 8])};
				waddata_WadDataGlobal.addBspMap(map);
			}
		}
	}
	,readDirectoryData: function(_offset) {
		var dir = { lumpOffset : this.bytesToInteger(_offset), lumpSize : this.bytesToInteger(_offset + 4), lumpName : this.stringFromBytesRange(_offset + 8,_offset + 15)};
		return dir;
	}
	...
	,__class__: waddata_packages_WadReader
};
var waddata_packages_processed_PLineDef = function(_start,_end) {
	this.start = _start;
	this.end = _end;
};
$hxClasses["waddata.packages.processed.PLineDef"] = waddata_packages_processed_PLineDef;
waddata_packages_processed_PLineDef.__name__ = true;
waddata_packages_processed_PLineDef.prototype = {
	start: null
	,end: null
	,__class__: waddata_packages_processed_PLineDef
};
var waddata_packages_processed_PMap = function(_map) {
	this.min_y = Infinity;
	this.min_x = Infinity;
	this.a_rvertex = _map.vertexes;
	this.a_rlinedef = _map.linedefs;
	this.process();
};
$hxClasses["waddata.packages.processed.PMap"] = waddata_packages_processed_PMap;
waddata_packages_processed_PMap.__name__ = true;
waddata_packages_processed_PMap.prototype = {
	a_rvertex: null
	,a_rlinedef: null
	,a_pvertex: null
	,a_plinedef: null
	...
	,process: function() {
		this.a_pvertex = [];
		var _g = 0;
		var _g1 = this.a_rvertex;
		while(_g < _g1.length) {
			var a = _g1[_g];
			++_g;
			this.a_pvertex.push(new waddata_packages_processed_PVertex(a.x,a.y));
			if(a.x < this.min_x) {
				this.min_x = a.x;
			}
			if(a.y < this.min_y) {
		...
		this.a_plinedef = [];
		var _g2 = 0;
		var _g3 = this.a_rlinedef;
		while(_g2 < _g3.length) {
			var a1 = _g3[_g2];
			++_g2;
		}
	}
	,draw_automap: function(_frame,_scale) {
		if(_scale == null) {
			_scale = 15;
		}
		...
		while(_g < _g1.length) {
			var a = _g1[_g];
			++_g;
			var sx = (this.a_pvertex[a.start].x + this.min_x) / _scale;
			var sy = (this.a_pvertex[a.start].y + this.min_y) / _scale;
			var ex = (this.a_pvertex[a.end].x + this.min_x) / _scale;
			var ey = (this.a_pvertex[a.end].y + this.min_y) / _scale;
			_graphics.drawLine(sx,sy,ex,ey);
		}
	}
	,__class__: waddata_packages_processed_PMap
};
var waddata_packages_processed_PVertex = function(_x,_y) {
	geom_Point.call(this,_x,_y);
};
$hxClasses["waddata.packages.processed.PVertex"] = waddata_packages_processed_PVertex;
waddata_packages_processed_PVertex.__name__ = true;
waddata_packages_processed_PVertex.__super__ = geom_Point;
waddata_packages_processed_PVertex.prototype = $extend(geom_Point.prototype,{
	__class__: waddata_packages_processed_PVertex
});
...
waddata_WadDataGlobal.iwad_data = new haxe_ds_StringMap();
waddata_WadDataGlobal.iwad_keys = [];
waddata_WadDataGlobal.maps = new haxe_ds_StringMap();
Main.main();
